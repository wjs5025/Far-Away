            ...
            <div class="container col-4 ">
                ...
                <div class="form-group d-flex">
                    <div class="col-5">
                        ...
                        <input type="email" class="form-control" id="email_id" name="email_id" value="${user.emailId}" readonly
                    ...
                    <div class="col-6">
                        ...
                        <input type="email" class="form-control" id="email_domain" name="email_domain" value="${user.emailDomain}" readonly
                               aria-describedby="emailHelp">
                    </div>
                </div>

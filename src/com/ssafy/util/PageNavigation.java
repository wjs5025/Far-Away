...
public class PageNavigation {
    ...
    public void makeNavigator() {
        ...
        for (int i = startPage; i <= endPage; i++) {
            builder.append("			<li class=\"" + (currentPage == i ? "page-item active" : "page-item") + "\" data-pg=\"" + i + "\"><a href=\"javascript:void(0)\" onclick=\"getAttractionData(" + i + ")\" class=\"page-link\">" + i + "</a></li> \n");
        }
